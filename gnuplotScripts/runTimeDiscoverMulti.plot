...
set output "runTime_discovar_multi.pdf"
...
plot for [COL=2:3] 'runTime/discovar/D2' using COL:xticlabels(1) notitle

set title "E. coli str. K-12 substr. MG1655"
plot for [COL=2:3] 'runTime/discovar/D3' using COL:xticlabels(1) notitle 

set title "Salmonella enterica"
plot for [COL=2:3] 'runTime/discovar/D4' using COL:xticlabels(1) notitle

set title "Pseudomonas aeruginosa"
plot for [COL=2:3] 'runTime/discovar/D5' using COL:xticlabels(1) notitle 

set title "Human Chr 21"
plot for [COL=2:3] 'runTime/discovar/D6' using COL:xticlabels(1) notitle
